...
| [DR-010](DECISIONS_PHASE2.md#dr-010) | Fail-fast on unsafe Git state — refuse to operate inside an unfinished merge/rebase/cherry-pick/revert/bisect or with unresolved conflicts | DECIDED (retroactive); AMENDED 2026-06-06 (DR-017 carve-out for Resolve-Conflict) | 2 | PROJECT_MANIFEST.md "Immutable Rules"; Public/Save-Work.ps1 CBH |
...
| [DR-017](DECISIONS_PHASE4.md#dr-017) | Resolve-Conflict — plain-English, strategy-based conflict resolution (keep mine/theirs/both via Git's own merge machinery); sanctioned exception to DR-010 | DECIDED (2026-06-06); implementation Phase 4 follow-on | 4 | docs/DESIGN-CONFLICT-RESOLVER.md; DR-010 amendment |
