...
> **GitEasy is not currently accepting outside contributions.**
>
> The project is maintained by a single author and there is no contributor
> license agreement (CLA) in place. Pull requests will not be reviewed or
> merged at this time. If you found a bug, please open an
> [Issue](https://github.com/greenmtnsun/GitEasy/issues) — those are welcome.
>
> The rules below are the maintainer's own quality bar, kept in the repo
> for transparency. They describe how the author writes code for this
> project. They are **not** a contribution invitation.
