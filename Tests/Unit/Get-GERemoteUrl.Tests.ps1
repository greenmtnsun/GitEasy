...
$RelativePath  = 'Private\Get-GERemoteUrl.ps1'
$SourcePath    = Join-Path $ProjectRoot $RelativePath

Describe 'Get-GERemoteUrl (private contract)' {
    ...
    It 'declares a function whose name matches the file name' {
        $script:Fn.Name | Should Be 'Get-GERemoteUrl'
    }
    ...
    It 'declares the -RemoteName parameter' {
        ...
        $names -contains 'RemoteName' | Should Be $true
    }
