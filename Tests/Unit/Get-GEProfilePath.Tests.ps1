...
$RelativePath  = 'Private\Get-GEProfilePath.ps1'
$SourcePath    = Join-Path $ProjectRoot $RelativePath
}

Describe 'Get-GEProfilePath (private contract)' {
    ...
    It 'declares a function whose name matches the file name' {
        $script:Fn.Name | Should -Be 'Get-GEProfilePath'
    }
    ...
    It 'declares the -OverridePath parameter' {
        $names = @()
        ...
        $names -contains 'OverridePath' | Should -Be $true
    }
