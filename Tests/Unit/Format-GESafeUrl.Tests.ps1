...
$RelativePath  = 'Private\Format-GESafeUrl.ps1'
$SourcePath    = Join-Path $ProjectRoot $RelativePath
}

Describe 'Format-GESafeUrl (private contract)' {
    ...
    It 'declares a function whose name matches the file name' {
        $script:Fn.Name | Should -Be 'Format-GESafeUrl'
    }
    ...
    It 'declares the -Url parameter' {
        ...
        $names -contains 'Url' | Should -Be $true
    }
