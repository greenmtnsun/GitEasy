...
$RelativePath  = 'Private\Get-GEHistory.ps1'
$SourcePath    = Join-Path $ProjectRoot $RelativePath

Describe 'Get-GEHistory (private contract)' {
    ...
    It 'declares a function whose name matches the file name' {
        $script:Fn.Name | Should Be 'Get-GEHistory'
    }
    ...
    It 'declares the -Count parameter' {
        ...
        $names -contains 'Count' | Should Be $true
    }
