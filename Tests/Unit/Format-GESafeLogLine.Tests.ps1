...
$RelativePath  = 'Private\Format-GESafeLogLine.ps1'
$SourcePath    = Join-Path $ProjectRoot $RelativePath

Describe 'Format-GESafeLogLine (private contract)' {
    ...
    It 'declares a function whose name matches the file name' {
        $script:Fn.Name | Should Be 'Format-GESafeLogLine'
    }
    ...
    It 'declares the -Line parameter' {
        $names = @()
        ...
        $names -contains 'Line' | Should Be $true
    }
